...
require('lazy').setup({
      ...
      local servers = {
        ...
        rust_analyzer = {
          settings = {
            ['rust-analyzer'] = {
              cargo = {
                features = { 'nightly', 'tx_generator', 'test_features', 'protocol_feature_spice' },
                autoreload = true,
                extraEnv = { RUSTUP_TOOLCHAIN = '' },
              },
              imports = {
                group = { enable = true },
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      vim.cmd.colorscheme 'snowflake-custom'
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'rust', 'toml', 'vim', 'vimdoc' }
